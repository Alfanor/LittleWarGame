...
--
-- Structure de la table `area_ressources`
--

CREATE TABLE `area_ressources` (
...
--
-- Déchargement des données de la table `area_ressources`
--

INSERT INTO `area_ressources` (`id`, `ressource_id`, `area_id`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 2),
(4, 4, 2);
...
CREATE TABLE `village_farmer` (
  `village_id` mediumint(3) UNSIGNED NOT NULL,
  `area_ressources_id` int(4) UNSIGNED NOT NULL,
  `worker` smallint(2) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Index pour la table `area_ressources`
--
ALTER TABLE `area_ressources`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `village_farmer`
  ...
  ADD KEY `fk_village_farmer_area_ressources1_idx` (`area_ressources_id`);
...
--
-- AUTO_INCREMENT pour la table `area_ressources`
--
ALTER TABLE `area_ressources`
...
--
ALTER TABLE `inventory`
  MODIFY `id` mediumint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- Contraintes pour la table `area_ressources`
--
ALTER TABLE `area_ressources`
...
--
ALTER TABLE `village_farmer`
  ADD CONSTRAINT `fk_village_farmer_area_ressources1` FOREIGN KEY (`area_ressources_id`) REFERENCES `area_ressources` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
