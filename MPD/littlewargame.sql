...
CREATE TABLE IF NOT EXISTS `ressource` (
  ...
  `probability` TINYINT(1) UNSIGNED NOT NULL DEFAULT 100,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `inventory_ressource` (
  ...
  UNIQUE INDEX `unique_inventory_ressource` (`inventory_id` ASC, `ressource_id` ASC),
...
CREATE TABLE IF NOT EXISTS `village_farmer` (
  ...
  UNIQUE INDEX `unique_couple` (`village_id` ASC, `area_ressource_id` ASC),
...
CREATE TABLE IF NOT EXISTS `technology` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_technology_building1_idx` (`building_id` ASC),
  INDEX `fk_technology_inventory1_idx` (`inventory_id` ASC),
  CONSTRAINT `fk_technology_building1`
    FOREIGN KEY (`building_id`)
    REFERENCES `building` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_technology_inventory1`
    FOREIGN KEY (`inventory_id`)
    REFERENCES `inventory` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
